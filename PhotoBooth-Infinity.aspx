            ...
            <tbody>
                ...
                <tr>
                    <td style="width: 75%;">
                        ...
                        <p>
                            &nbsp;</p>
                        <form id="PhotoBoothForm" method="post" enctype="multipart/form-data">
                            <table style="border: 0; width: 100%;">
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%; vertical-align: top" rowspan="7"><strong>Badge Preview and Print</strong><br />
                                        <table style="border: groove; width: 50%; align-self: center;">
                                            <tr>
                                                <td style="width: 290px;" class="text-center">Picture</td>
                                            </tr>
                                            <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%;"><span>
                                        <a>
                                            <input type='file' class='file' id='Visitor_Photo' name='Visitor_Photo' required="required" runat="server" /></a></span></td>
                                </tr>
                                <tr>
                                ...
                                <tr>
                                    ...
                                    <td style="width: 30%;">
                                        <span>
                                            ...
                                            <input type='submit' id='Submit' name='Submit' value='Submit' runat="server" />
                                        </span>
                                    </td>
                                </tr>
